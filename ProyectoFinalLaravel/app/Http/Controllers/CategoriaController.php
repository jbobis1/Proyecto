...
class CategoriaController extends Controller
{
    ...
    {
     // Cambia 'all()' por 'paginate()' para agregar paginación
     $myteams = CategoriaModel::paginate(4); // Cambia '10' al número de elementos por página que desees
     $url = 'storage/';
    ...
    public function show($id)
    {
        ...
        $poducto = Product::where('category_id',  $categoria->id )
        ->get();
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            return redirect()->route('categoria.index')
          ->with('success_msg', 'Categoria No eliminados ');
